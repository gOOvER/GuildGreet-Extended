...
GLDG_TXT.whisperLevelup	= "Levelup anflüstern *"
...
GLDG_TXT.autoAssignEgp	= "(EGP-Offiziersnotiz berücksichtigen) *"
...
GLDG_TXT.extendIgnored	= "Im Chat den Namen des Mains auch dann vor Nachricht stellen, wenn der Charakter ignoriert wird *"
...
GLDG_TXT.noGratsOnLogin	= "Beim Einloggen nicht gratulieren *"
