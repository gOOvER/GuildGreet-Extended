...
--GLDG_TXT.whisper	= "Whisper greetings and grats to players *"
--GLDG_TXT.whisperLevelup	= "Whisper level up messages *"
...
--GLDG_TXT.extendIgnored	= "Add main name to chat when an alt sends a message, even if alt is ignored *"
...
--LDG_TXT.supressAchievment = "Don't put players that get achievments on the greet list *"
...
--GLDG_TXT.extendPlayerMenu = "Enable player context menu (may cause taint issues in raid frame, see tooltip)"
