...
--GLDG_TXT.colDefault	= "Default colours" menu
...
--GLDG_TXT.help_alert		= "Check if |cFFFFFF7FGuild member notification|r is enabled" noargs
...
--GLDG_TXT.argmissing		= "Another argument is needed after command" main
GLDG_TXT.by			= "by"
...
-- delta popup
--GLDG_TXT.deltaGuild	= "Guild" -- L["Guild"]
...
-- Player menus
--GLDG_TXT.menu		= "GuildGreet" -- L["GuildGreet"]
