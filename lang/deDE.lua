...
L["Don't put players that level up on the greet list"] = "Charaktere, die einen neuen Level erreicht haben, nicht in Grussliste setzen"
...
L["has increased his level from %s to %s"] = "hat seinen Level von %s auf %s erhöht"
...
L["List to chat when a player levels up (offline players, printed when you log in)"] = "Im Chat anzeigen, wenn ein Spieler einen neuen Level erreicht hat (offline Spieler, wird angezeigt wenn Du einloggst)"
L["List to chat when a player levels up (online only)"] = "Im Chat anzeigen, wenn ein Spieler einen neuen Level erreicht hat (nur online)"
L[" Main character for this player is %s."] = " Main dieses Spielers ist %s."
L["Manage friend's list"] = "Freunde-Liste verwalten"
...
L["Using default chat frame"] = "Standard Chat-Fenster verwenden"
