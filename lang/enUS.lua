...
L["Level Settings"] = true
L["Minimum level to greet"] = true
L["Maximum level to greet"] = true
...
L["joined the channel"] = true
L["%s : select the greeting category you want to edit"] = true
L["<none>"] = true
L["Achievement Points"] = true
L["Alt of"] = true
L["Always show level-up"] = true
L["Always show relogs"] = true
L["Another argument is needed after command"] = true
L["Available backups:"] = true
L["Backup created: %s"] = true
L["Backup not found:"] = true
L["Channel members: %d"] = true
L["ChatMsg/Config string found. GuildGreet using default settings from %s!"] = true
L["ChatMsg/The config string seems to be corrupted. Please inform %s!"] = true
L["Circular main-alt reference detected"] = true
L["Collection %q"] = true
L["Conflict resolved for"] = true
L["Data conversion completed"] = true
L["Data issues found: %d"] = true
L["Data restored from backup: %s"] = true
L["Database initialized successfully"] = true
L["Default colors restored"] = true
L["Details for"] = true
L["Display a maximum of %d queued players"] = true
L["earned the achievement"] = true
L["Editbox/Bye"] = true
L["Fixed %d issues"] = true
L["Fixed: Removed invalid alt reference from"] = true
L["Fixed: Removed main flag from"] = true
L["Fixed: Removed self-reference from"] = true
L["Fixed: Set main flag for"] = true
L["Friends: %d"] = true
L["Guild members: %d"] = true
L["has earned"] = true
L["Migration Report:"] = true
L["Migration tasks needed:"] = true
L["New friend"] = true
L["No backups found"] = true
L["No characters found"] = true
L["No data issues found"] = true
L["No issues found to fix"] = true
L["Only show level-up for levels above %d"] = true
L["Only update guild roster on events"] = true
L["Player"] = true
L["Player has invalid main reference"] = true
L["Player has rank number but no rank name"] = true
L["Player not found"] = true
L["Promote to main"] = true
L["Public Note"] = true
L["Purged %d characters"] = true
L["Remove selection"] = true
L["Roster import completed"] = true
L["Select main for character %s"] = true
L["Starting data conversion..."] = true
L["Total players: %d"] = true
L["Type |cFFFFFF7F/gg convert|r to start migration"] = true
L["Update guild roster every %d seconds"] = true
L["Using chat frame %d (%s)"] = true
L["Using default chat frame"] = true
L["Verifying data consistency..."] = true
L["was demoted to"] = true
L["was promoted to"] = true
L["went offline"] = true
L["Zone"] = true