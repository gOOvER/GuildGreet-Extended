...
L["ChatMsg/Config string found. GuildGreet using default settings from %s!"] = "Sequência de configuração encontrada. GuildGreet está usando configurações padrões de %s!"
L["ChatMsg/Config string not found."] = "Sequência de configuração não encontrada"
L["ChatMsg/GuildGreet using default settings!"] = "GuildGreet está usando ajustes padrões"
L["ChatMsg/GuildGreet using your own settings!"] = "GuildGreet está usando suas próprias configurações!"
L["ChatMsg/GuildGreet using your own settings (But a config string is in the guild info available)."] = "GuildGreet está usando suas próprias configurações (Mas uma string de ajuste está disponível na Info da Guild)"
L["ChatMsg/GuildGreet using your own settings. But the config string seems to be corrupted. Please generating a new one."] = "GuildGreet está usando suas próprias configurações. Mas parece que há alguma configuração corrompida. Gerando novas,"
L["ChatMsg/GuildGreet using your own settings. But the config string seems to be corrupted. Please inform %s!"] = "GuildGreet está usando suas próprias configurações. Mas parece que há alguma configuração corrompida. Por favor, informe %s!"
L["ChatMsg/Guild info written successfully!"] = "Informação da Guild escrita com sucesso!"
L["ChatMsg/Note to the guild master to create the config string"] = "Seja gentil com os membros da sua guild e escreva as strings de configurações na Informação da Guild."
L["ChatMsg/The config string seems to be corrupted. Please generating a new one."] = "A string de configuração aparenta estar corrompida. Gerando uma nova."
L["ChatMsg/The config string seems to be corrupted. Please inform %s!"] = "A string de configuração aparenta estar corrompida. Por favor, informe %s!"
L["ChatMsg/The guild info is too long..."] = "A informação da guild é muito extensa, exclua ao menos %d caracteres e tente novamente!"
L["ChatMsg/To set the config string ..."] = "Para definir uma sequência de configução, use o comando /gg, desmarque a opção <Ler configuração da guild da info da guild>, reconecte, faça as configurações para seus membros e pressione <Escrever seq. de configuração>"
L["Editbox/Achievment"] = "Editar parabenização de conquista: primeiro %s é o jogador, segundo %s é a conquista"
L["Editbox/Bye"] = "Editar mensagem de saída (dia) para jogadores: primeiro uso do %s é o nome do jogador"
L["Editbox/ByeChannel"] = "Editar mensagem para dizer 'Adeus' ao canal"
L["Editbox/ByeGuild"] = "Editar mensagem para dizer 'adeus' à guild: primeiro uso do %s será o nome da guild"
L["Editbox/Channel"] = "Editar mensagem de saudação no canal: primeiro uso do %s será o nome da guild"
L["Editbox/Greet"] = "Editar mensagem de saudação padrão: primeiro uso do %s será o nome do jogador"
L["Editbox/GreetBack"] = "Editar mensagem de saudação para reconect.: primeiro uso do %s será o nome do jogador"
L["Editbox/Guild"] = "Editar saudação da guild: Primeiro uso do %s será o nome da guild"
L["Editbox/LaterChannel"] = "Editar mensagem para dizer 'Vejo você mais tarde' no canal"
L["Editbox/LaterGuild"] = "Editar mensagem para dizer 'Vejo você mais tarde' na guild: Primeiro uso do %s é o nome da guild"
L["Editbox/NewLevel"] = "Editar parabenizações de novo nível: primeiro %s será o jogador, segundo %s será o novo level"
L["Editbox/NewRank"] = "Editar parabenizações de promoção: primeiro %s é o jogador, segundo %s é o novo posto"
L["Editbox/Night"] = "Editar mensagem de saída (noite) para jogadores: primeiro uso do %s será o nome do jogador"
L["Editbox/NightChannel"] = "Editar mensagem de despedida no canal"
L["Editbox/NightGuild"] = "Editar mensagem de boa noite (despedida) na guild: primeiro uso do %s é o nome da guild"
L["Editbox/Welcome"] = "Editar saudação de boas vindas: primeiro uso do %s é o nome do jogador"
