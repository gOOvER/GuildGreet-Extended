...
L["Always show relogs"] = "总是显示重新记录" -- Needs review
L["At %s, %s promoted this player to rank %s."] = "位于 ％s，％s 的晋升这个球员的排名 ％s 秒。" -- Needs review
L["At %s, this character came back online after being offline for %s."] = "％s 的，这个人物是离线 ％s 的后回来在线" -- Needs review
L["At %s, this character came online for the first time during this session."] = "％s 的，这个人物在网上来了本次会议期间的第一次。" -- Needs review
L["At %s, this player joined the guild"] = "位于 ％s，该球员加入公会" -- Needs review
L["(Automatically assign Alias)"] = "(自动指定别名)" -- Needs review
...
L["Character reached level %s."] = "角色达到等级 ％s 秒。" -- Needs review
L[" Character used by player previously was %s."] = "使用玩家角色以前是 ％s 的" -- Needs review
L["Clear greet list"] = "清除迎接列表" -- Needs review
-- L["Collection %q"] = ""
-- L["coming online"] = ""
...
L[" Main character for this player is %s."] = "主角的这个球员是 ％s" -- Needs review
...
-- L["night char"] = ""
-- L["night guild"] = ""
L["No characters found"] = "没有找到字符" -- Needs review
-- L["<none>"] = ""
-- L["not defined"] = ""
L[" (off)"] = "离" -- Needs review
-- L["Only show level-up for levels above %d"] = ""
L["Only show relogs after more then %d min"] = "经过再为 ％d 分钟只显示重新记录" -- Needs review
-- L["Only update guild roster on events"] = ""
L["Open config window"] = "打开配置窗口" -- Needs review
-- L["optionHeader"] = ""
L["Player has achieved %s."] = "玩家取得了％s的。" -- Needs review
L["Player joined the guild before you logged on."] = "玩家取得了 ％s 的。" -- Needs review
L["Player was promoted to rank %s before you logged on."] = "玩家晋升为排名 ％s 的你登录之前。" -- Needs review
-- L["Printing information to chat"] = ""
-- L["promotion"] = ""
-- L["Randomly use alias and or main and alt names"] = ""
L["RANK"] = "级" -- Needs review
-- L["Read the guildsettings from the guild info |cFFFF0000You must reload your interface after change this manually!"] = ""
-- L["relogging"] = ""
-- L["Remove selection"] = ""
L["Say goodbye to guild and channel"] = "告别公会和渠道" -- Needs review
L["Say see you later to guild and channel"] = "说看你以后到公会和渠道。" -- Needs review
...
L["%s promoted the player to rank %s earlier."] = "％s 的促进了玩家的排名 ％s 的前面" -- Needs review
-- L["%s : select the greeting category you want to edit"] = ""
L["SubTabChat"] = "交谈" -- Needs review
L["SubTabDebug"] = "调试" -- Needs review
L["SubTabGeneral"] = "总" -- Needs review
L["SubTabGreeting"] = [=[欢迎
...
L["TabColour"] = "颜色" -- Needs review
L["TabGreetings"] = "问候" -- Needs review
L["TabPlayers"] = "字符" -- Needs review
L["TabSettings"] = [=[竖立
]=] -- Needs review
L["TabTodo"] = "信息" -- Needs review
-- L["Temporarily suppress greeting players"] = ""
L["Test trigger"] = "测试触发" -- Needs review
